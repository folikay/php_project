...
<body class="preload">
    ...
    <!--section1 for support page-->


    <section class="support-section">
        <div class="que">
        <h1>Support Center</h1>
        <p>Welcome to our Support Center. How can we assist you today?</p></div>
<div>
    <!--
        <h2>Frequently Asked Questions (FAQs)</h2>
        <ul>
            <li><strong>Q:</strong> How do I create an account?<br>
                <strong>A:</strong> Click on the "Sign Up" button on the top right corner and fill in the required details.</li>
            <li><strong>Q:</strong> How can I reset my password?<br>
                <strong>A:</strong> Click on "Forgot Password" on the login page and follow the instructions to reset your password.</li>
            <li><strong>Q:</strong> Where can I find your pricing plans?<br>
                <strong>A:</strong> Visit our <a href="plan.html">Pricing Plans</a> page for detailed information.</li>
        </ul>-->
</div>

 <!-- Search Form -->
    <div class="search1-container">
        <form class="search1-form" method="GET" action="">
            <input type="text" name="query" class="search1-input" placeholder="Search for pages or content..." required>
            <button type="submit" class="search1-button">Search</button>
        </form>
    </div>

    <!-- PHP will output results here -->
    <div class="results">
        <?php
        // PHP logic goes here (see below)
        ?>
    </div>
<?php
...
$pages = [
    [
        'title' => 'Home Page',
        'url' => 'index.html',
        'description' => 'Welcome to our home page with general information.'
    ],
    [
        'title' => 'About Us',
        'url' => 'about.html',
    ...
    [
        'title' => 'Blog',
        'url' => 'hero.php',
        'description' => 'Get more and lastest update on our page.'
    ],
    [
        'title' => 'Contact',
        'url' => 'contact.php',
    ...
    [
        'title' => 'Products',
        'url' => 'products.html',
        'description' => 'Browse our range of products and services.'
    ],
...
if (isset($_GET['query']) && !empty(trim($_GET['query']))) {
    $query = strtolower(trim($_GET['query'])); // Sanitize and lowercase the query
    $results = [];

    // Search through pages for matches in title or description
    foreach ($pages as $page) {
        if (strpos(strtolower($page['title']), $query) !== false || strpos(strtolower($page['description']), $query) !== false) {
            $results[] = $page;
        }
    }
    ...
    if (!empty($results)) {
        ...
        foreach ($results as $result) {
            ...
            echo '<a href="' . htmlspecialchars($result['url']) . '" class="result-link">' . htmlspecialchars($result['title']) . '</a>';
            echo '<i>' . htmlspecialchars($result['description']) . '</i>';
            echo '</div>';
        }
    } else {
        echo '<p class="no-results">No results found for "' . htmlspecialchars($query) . '". Try a different search term.</p>';
    }
} else {
    // No query submitted, show nothing or a prompt
    echo '<p>Enter a search term above to find pages on our site.</p>';
}
?>
<div class="answer">
        <h2>Contact Us</h2>
        ...
        <ul>
            <li>Email:graceoluwakunmi@gmail.com</li>
            <li>Phone: +234-810-669-909</li>
            <li>Address: Plot 4, Ilorin</li>
        </ul>
    </div>
    </section>
...
<h1><b>New to Osamfem?</b><i>start here....</i></h1>

<div class="flex-container">
  <a href="https://www.vecteezy.com/free-videos/civil-engineer"><img src="team10.jpg" alt="sam">video tutorial</a>
    <a href="https://www.storyblocks.com/video/search/civil+engineer"><img src="plan1.webp" alt="sam">video tutorial</a>
      <a href="https://www.vecteezy.com/free-videos/construction"><img src="gride3.jpg" alt="sam">video tutorial</a>
